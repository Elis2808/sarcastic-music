    ...
    <div className="flex flex-col items-center w-full pt-8 px-4 max-sm:pt-6 max-sm:px-3">
      ...
      >
        <div className="flex flex-col items-center gap-3 w-full">
          ...
          />
          <div className={`max-w-xs w-full ${ytLoading ? "btn-sweep-wrapper" : "rounded-xl p-[3px] bg-gray-700"}`}>
            <button
              onClick={fetchInfo}
              disabled={ytLoading || !ytUrl.trim()}
              className="w-full px-6 py-2.5 rounded-[10px] bg-black hover:bg-gray-900 active:scale-95 disabled:opacity-50 disabled:cursor-not-allowed text-white text-sm font-medium transition-all duration-200 outline-none flex items-center justify-center gap-2"
            >

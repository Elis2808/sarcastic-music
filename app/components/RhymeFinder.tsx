...
export default function RhymeFinder({ onLookupWord, highlightWord, initialWord }: Props) {
  ...
  return (
    <div className="flex flex-col items-center w-full pt-8 px-4 max-sm:pt-6 max-sm:px-3">
      ...
      />
      <div className={`mt-3 w-36 ${isLoading ? "btn-sweep-wrapper" : "rounded-xl p-[1px]"}`} style={isLoading ? {} : {background: "linear-gradient(135deg, #8a6a1a, #C9A84C, #e8c96a, #C9A84C, #8a6a1a)"}}>
        <button
          onClick={() => search(word)}

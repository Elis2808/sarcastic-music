    ...
    <footer className="w-full bg-black border-t mt-16" style={{ borderColor: "rgba(201,168,76,0.2)" }}>
      <div className="max-w-4xl mx-auto px-4 py-6 flex flex-col sm:flex-row items-center justify-between gap-3">
        ...
        <div className="flex items-center gap-4 text-xs">
          ...
          <span className="text-gray-700">·</span>
          <a href="mailto:sarcasticmusic2120@gmail.com?subject=Feedback" className="text-gray-500 hover:text-[#C9A84C] transition-colors">Feedback</a>
          <span className="text-gray-700">·</span>
          <a href="mailto:sarcasticmusic2120@gmail.com?subject=Report%20an%20Issue" className="text-gray-500 hover:text-[#C9A84C] transition-colors">Report an Issue</a>
        </div>
      </div>
    </footer>
  );
